...
def dynamic_payment_link(employerNumber : int, worker_id : str, employer_id : str, cashAdvance : int, bonus : int, attendance : int, repaymentFlag : bool, db : Session = Depends(get_db)):
    return cashfree_api.dynamic_payment_link(employerNumber, worker_id, employer_id, cashAdvance, bonus, attendance, repaymentFlag, db)
