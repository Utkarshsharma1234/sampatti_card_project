...
def payment_link_generation(db : Session):
    ...
    for item in total_workers:
        ...
        send_whatsapp_message(employerNumber=item.employer_number, worker_name=item.worker_name, param3=f"{current_month} {current_year}", link_param=payment_session_id, template_name="salary_link_template")
