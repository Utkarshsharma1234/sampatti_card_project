...
def cash_advance_link(
    ...
    try:
        ...
        rashmita_sample_payment_link(employerNumber=employerNumber, salary=monthly_salary, advance_remaining=cash_advance, repayment=repayment_amount, total_amount=total_salary, link_param=payment_session_id, template_name="rashmita_sample_payment_link")
